...
function Initialize_Parameters() {		//Find parameters form the posted data.
	...
	//document.PARAMETERS.BIN_MIN.value = (DATA_MAX-DATA_MIN)/100;
	document.PARAMETERS.BIN_MIN.value = diff.toPrecision(6)*2;
	
	document.PARAMETERS.BIN_MAX.value = (DATA_MAX-DATA_MIN)/3;
...
function Results_In_Window() {
	...
	WIN_RESULTS.document.writeln("</table><hr><br></blockquote>");
	//WIN_RESULTS.document.writeln("</body></html>");
