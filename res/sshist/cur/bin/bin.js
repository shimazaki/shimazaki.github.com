...
function Results_In_Window() {
	...
	var LEN_OPT = 0; for (var i = 0; i < K_OPT.length; i++) {LEN_OPT = LEN_OPT+K_OPT[i];}
	for (var i = 0; i < K_OPT.length; i++) {
