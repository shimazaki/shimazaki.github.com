...
public class DemoHistogram extends java.applet.Applet {
	...
	Scrollbar scrl = new Scrollbar(Scrollbar.HORIZONTAL,D,20,8,300);
    ...
    public void init() {
    	...
    	for (int i=0; i<L; i++) {
    		t[i] = i*dt;
    		y[i] = 30*Math.sin(2*Math.PI*1.5*t[i]) + 20 + 20*t[i];
